...
<body>
                ...
                <div class="navbar-header" data-logobg="skin6">
                    ...
                    <div class="navbar-brand">
                        ...
                        <a href="{{route('index')}}">
                            ...
                            <!-- </span> -->
                            <img style="width:100%;"src="{{asset('assets/images/logo.png')}}" class="dark-logo"alt="hompeage"/>
                        </a>
                    </div>
                    <!-- ============================================================== -->
                    <!-- End Logo -->
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="javascript:void(0)" data-toggle="dropdown"
                                ...
                                <span class="ml-2 d-none d-lg-inline-block"><span>Hello,</span> <span
                                        class="text-dark">{{$data->Username}}</span> <i data-feather="chevron-down"
                    ...
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link has-arrow" href="javascript:void(0)"
                                aria-expanded="false"><i data-feather="file-text" class="feather-icon"></i><span
                                    class="hide-menu">User Accounts</span></a>
                            <ul aria-expanded="false" class="collapse  first-level base-level-line">
                                <li class="sidebar-item"><a href="{{route('user')}}" class="sidebar-link"><span
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link has-arrow" href="javascript:void(0)"
                                aria-expanded="false"><i data-feather="file-text" class="feather-icon"></i><span
                                    class="hide-menu">Loan Package Management</span></a>
                            <ul aria-expanded="false" class="collapse  first-level base-level-line">
                                <li class="sidebar-item"><a href="{{route('loanpackage')}}" class="sidebar-link"><span
                                            class="hide-menu">Loan Package
                                        </span></a>
                                </li>
                            </ul>
                        </li>
                        <li class="sidebar-item"> <a class="sidebar-link has-arrow" href="javascript:void(0)"
                                aria-expanded="false"><i data-feather="file-text" class="feather-icon"></i><span
                                    class="hide-menu">Loan Records</span></a>
                            <ul aria-expanded="false" class="collapse  first-level base-level-line">
                                <li class="sidebar-item"><a href="{{route('activeloan')}}" class="sidebar-link"><span
                                            class="hide-menu">Active Loan
                                        </span></a>
                                </li>
                                <li class="sidebar-item"><a href="{{route('loanapplication')}}" class="sidebar-link"><span
                                            class="hide-menu">Loan Application
                                        </span></a>
                                </li>
                                <li class="sidebar-item"><a href="{{route('pendingtransfer')}}" class="sidebar-link"><span
                                            class="hide-menu">Pending Transfer
                                        </span></a>
                                </li>
                                <li class="sidebar-item"><a href="{{route('rejectedloan')}}" class="sidebar-link"><span
                                            class="hide-menu">Rejected Loan
                                        </span></a>
                                </li>
                                <li class="sidebar-item"><a href="{{route('latepayment')}}" class="sidebar-link"><span
                                            class="hide-menu">Late Payment
                                        </span>&nbsp;<div class="badge badge-danger" style="color:white;"></div></a>
                                </li>
                                <li class="sidebar-item"><a href="{{route('completedloan')}}" class="sidebar-link"><span
                                            class="hide-menu">Completed Loan
                                        </span></a>
                                </li>
                            </ul>
                        </li>
                        ...
                        <ul aria-expanded="false" class="collapse  first-level base-level-line">
                            <li class="sidebar-item"><a href="{{route('staff.index')}}" class="sidebar-link"><span
                                        class="hide-menu">Staff List
                                    </span></a>
                            </li>
                        </ul>
                    </li>
                    <li class="sidebar-item"> <a class="sidebar-link sidebar-link" href="{{route('activitylog')}}"
                        aria-expanded="false"><i data-feather="message-square" class="feather-icon"></i><span
                            class="hide-menu">Activity Log</span></a></li>
                            <li class="sidebar-item"> <a class="sidebar-link sidebar-link" href="{{route('inquiry')}}"
                                aria-expanded="false"><i data-feather="message-square" class="feather-icon"></i><span
    ...
    <script>    
        ...
        $(".toggle-class").on("click", function () {
            let value = $(".toggle-class").prop("checked");
            
            $(".toggle-class").val(value);
        })
